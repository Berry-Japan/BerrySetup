...
type
  ...
  public
    ...
    procedure WritePhysicalDisk(Buffer:Pointer; count:DWORD); virtual; abstract;
  ...
  public
    ...
    procedure WritePhysicalDisk(Buffer:Pointer; count:DWORD); override;
...
procedure TNTDisk.WritePhysicalDisk(Buffer:Pointer; count:DWORD);
var
   WriteStart           : _Large_Integer;
   WriteLength          : DWORD;
   ActualLengthWritten  : DWORD;
