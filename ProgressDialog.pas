...
uses Windows, SysUtils, ActiveX, Classes, Graphics, Controls;
...
Begin
  while (fOwner.iiProgressDialog.HasUserCancelled=0) do              // TODO: AV here...
    Sleep(250);
  fOwner.iiProgressDialog:=nil;      // Free the dialog -- todo: move this?
